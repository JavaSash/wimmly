...
3. Add income
   ...
   3.10 сумма <0 - ошибка
   3.11 сумма >9223372036854775807 - ошибка
   3.12 сумма не число (буква, спец символ) - ошибка
   3.13 сумма с разделителем , - ок
   3.14 сумма с пробелом в начале\в конце - ок
   3.15 коммент длиннее 50 символов - ошибка
   3.16 дата вида 1.1.2001 - ок
   3.17 дата до 1.1.1970 - ошибка
   3.18 дата в будущем - ошибка
   3.19 дата вида 11.11.2001 - ок
   3.20 дата с несуществующим числом месяца 30.02.2026 - ошибка
   3.21 дата с несуществующим месяцем 15.13.2026 - ошибка
4. Add expense
...
10. /delete_transaction
    10.1 номер транзакции < 0 - ошибка
    10.2 номер транзакции > 2147483647 - ошибка
    10.3 номер транзакции не число (содержит буквы или спец символы) - ошибка
    10.4 транзакции с таким номером не существует - ошибка
    10.5 введён верный номер транзакции - транзакция удалена (не отображается при поиске)
    10.6 при удалении транзакции когда транзакции не найдены не предлагает удалить (Удалить транзакцию? Yes/No)
11. 
