...
) : AbstractCommand(BotCommand.REPORT_MONTH, usersRepository, applicationEventPublisher, userService) {

    override fun doPrepare(user: User, chat: Chat, arguments: Array<out String>) {
        usersRepository.updateUserStep(chat.id, StepCode.REPORT_MONTH)
    }
}