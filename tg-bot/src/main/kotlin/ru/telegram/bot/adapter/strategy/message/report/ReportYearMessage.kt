...
@Component
class ReportYearMessage(messageWriter: MessageWriter) : AbstractSendMessage<BalanceDto>(messageWriter) {
    ...
    override fun message(data: BalanceDto?): String {
        logger.info { "$$$ ReportYearMessage.message data: $data" }
        ...
        return messageWriter.process(StepCode.REPORT_YEAR, templateData)
    }
}