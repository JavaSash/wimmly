...
@Component
class ReportTodayChooser(private val chatContextRepository: ChatContextRepository) : MessageChooser {

    override fun execute(chatId: Long, message: Message) {
        chatContextRepository.updateUserStep(chatId, StepCode.REPORT_TODAY)
    }
}