...
class AskDeleteTransactionChooserTest {
    @Mock
    lateinit var chatContextRepository: ChatContextRepository

    private lateinit var chooser: AskDeleteTransactionChooser

    private val chatId = CHAT_ID

    @BeforeEach
    fun setup() {
        chooser = AskDeleteTransactionChooser(chatContextRepository)
    }
    ...
    @Test
    fun `execute should set accept false and return FINAL for NO`() {
